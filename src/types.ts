...
/** Which keycap backdrop to use for the app icon / brand mark. */
export type AppIcon = "cream" | "paper" | "sand";
...
export interface AuthorSettings {
  ...
  /** Which keycap backdrop to show for the app icon / brand mark. */
  appIcon: AppIcon;
}
 ...
 *  belong to the same author, it's created `accepted` immediately (you own both
 *  sides), though the author still names the bond. */
